                ...
                <form action="<?= site_url('users/update?id='.$user['id']) ?>" method="post" class="form mb-3 row">
                    ...
                    <div class="col-6">
                        <div class="input-group input-group-static mb-3">
                            ...
                            <input type="text" name="name" id="" class="form-control ps-2" value="<?= $user['user_name'] ?>" required>
                    ...
                    <div class="col-6">
                        <div class="input-group input-group-static mb-3">
                            ...
                            <input type="text" name="email" id="" class="form-control ps-2" value="<?= $user['user_email'] ?>">
                    ...
                    <div class="input-group input-group-static mb-3 ">
                        ...
                        <input type="password" name="password" id="password" class="form-control ps-2" value="<?= set_value('password') ?>" required>
